package com.mavelinetworks.mavelideals.security;
...
import com.mavelinetworks.mavelideals.utils.SecurityUtils;
...
public class Security {
    ...
    public static String getDecryptedResponse(String response){
        ...
        Security.KeyIV  = SecurityUtils.md5(ANDROID_API_KEY +"1@"+ AppController.getTokens().get("token-1"))
                .toLowerCase().substring(0,16);
        Security.SKey   = SecurityUtils.md5(ANDROID_API_KEY +"2@"+ AppController.getTokens().get("token-0"))
                .toLowerCase().substring(0,16);
    ...
    public static Map<String ,String> cryptedData00(Map<String ,String > params){
        ...
        String hashed = Security.cryptHashMap00(params);
