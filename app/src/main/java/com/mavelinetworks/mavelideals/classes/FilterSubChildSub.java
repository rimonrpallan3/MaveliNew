...
public class FilterSubChildSub extends RealmObject implements Serializable {
    ...
    public FilterSubChildSub(String offerTypeId, String nameFilt, String offerParentId, String offerImage, int status) {
