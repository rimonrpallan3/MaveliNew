...
public class FilterChild extends RealmObject implements Serializable {
    ...
    private int status;
    private RealmList<FilterSubChild> filterSubChild;
    ...
    public FilterChild(String offerTypeId, String nameFilt, String offerParentId, String offerImage, int status) {
    ...
    public RealmList<FilterSubChild> getFilterSubChild() {
        return filterSubChild;
    }

    public void setFilterSubChild(RealmList<FilterSubChild> filterSubChild) {
        this.filterSubChild = filterSubChild;
    }
